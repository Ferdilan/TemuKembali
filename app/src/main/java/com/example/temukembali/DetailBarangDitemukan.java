...
public class DetailBarangDitemukan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_barang_ditemukan);
        ...
        if (status != null && status.equalsIgnoreCase("ditemukan")) {
            ...
            db.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        if (penemuNama != null && penemuNim != null) {
                            ...
                            tvPenemu.setText("Pemilik belum teridentifikasi");
                            tvPenemu.setVisibility(View.VISIBLE);
                        }
                    }
                }
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(DetailBarangDitemukan.this, "Gagal memuat data penemu", Toast.LENGTH_SHORT).show();
                }
            });
        } else {
        ...
        buttonKonfirmasi.setOnClickListener(v -> {
            ...
            new AlertDialog.Builder(DetailBarangDitemukan.this)
                    .setTitle("Konfirmasi")
                        ...
                        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    ...
                                    if (nimPenemu != null && namaPenemu != null){
                                        ...
                                        db.updateChildren(updates).addOnCompleteListener(task -> {
                                            if (task.isSuccessful()) {
                                                ...
                                                buttonKonfirmasi.setVisibility(View.GONE);
                                                Toast.makeText(DetailBarangDitemukan.this,
                                    ...
                                    Toast.makeText(DetailBarangDitemukan.this, "Data pengguna tidak ditemukan", Toast.LENGTH_SHORT).show();
                                }
                            }

                            @Override
                            public void onCancelled(@NonNull DatabaseError error) {
                                Toast.makeText(DetailBarangDitemukan.this, "Gagal mengambil data pengguna", Toast.LENGTH_SHORT).show();
                            }
                        });
                    })
